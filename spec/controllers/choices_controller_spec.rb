  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved choice as @choice" do
        ...
        post :create, {:choice => { "body" => "invalid value" }}, valid_session
        assigns(:choice).should be_a_new(Choice)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested choice" do
        ...
        Choice.any_instance.should_receive(:update).with({ "body" => "MyText" })
        put :update, {:id => choice.to_param, :choice => { "body" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the choice as @choice" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Choice.any_instance.stub(:save).and_return(false)
        put :update, {:id => choice.to_param, :choice => { "body" => "invalid value" }}, valid_session
        assigns(:choice).should eq(choice)
      end
