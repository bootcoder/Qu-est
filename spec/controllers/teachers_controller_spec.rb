  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved teacher as @teacher" do
        ...
        post :create, {:teacher => { "first_name" => "invalid value" }}, valid_session
        assigns(:teacher).should be_a_new(Teacher)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested teacher" do
        ...
        Teacher.any_instance.should_receive(:update).with({ "first_name" => "MyString" })
        put :update, {:id => teacher.to_param, :teacher => { "first_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the teacher as @teacher" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Teacher.any_instance.stub(:save).and_return(false)
        put :update, {:id => teacher.to_param, :teacher => { "first_name" => "invalid value" }}, valid_session
        assigns(:teacher).should eq(teacher)
      end
